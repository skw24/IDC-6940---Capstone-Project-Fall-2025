...
library(car)
library(caret)
model <- glm(stroke ~ genderadj + ageadj + hypertensionadj + heart_diseaseadj + ever_marriedadj + work_typeadj + Residence_typeadj + avg_glucose_leveladj + bmiadj + smoking_statusadj, data=StrokeAdj, family=binomial)
residualPlots(model)
...
knitr::spin("Stroke_Results_1019_2025_latest_440PM_SW_For_Group.r", knit = FALSE)
